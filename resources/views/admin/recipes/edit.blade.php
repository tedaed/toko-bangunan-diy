    ...
    <form action="{{ route('admin.recipes.update', $recipe->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                ...
                <input type="number"
                       name="length"
                       value="{{ old('length', $recipe->length) }}"
                       class="w-full border rounded p-2">
            </div>
            ...
            <div>
                ...
                <input type="number"
                       name="height"
                       value="{{ old('height', $recipe->height) }}"
                       class="w-full border rounded p-2">
            </div>
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea name="description"
                      rows="4"
                      class="w-full border rounded p-2">{{ old('description', $recipe->description) }}</textarea>
        </div>
